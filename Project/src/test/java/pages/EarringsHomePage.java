...
public class EarringsHomePage {
    ...
    public void clickOnsearchIcon() {
        try {
            ...
            Thread.sleep(1000);
            helper.waitForElementToBeClickable(EarringsHomePageLocator.clickOnsearchIcon, 5);
            helper.clickOnElement(EarringsHomePageLocator.clickOnsearchIcon);
    ...
    public void clickOnsearchBar() {
        try {
            helper.waitForElementToBeClickable(EarringsHomePageLocator.clickOnsearchBar, 5);
            helper.clickOnElement(EarringsHomePageLocator.clickOnsearchBar);
    ...
    public void enterAction() {
        try {
            helper.waitForElementToBeVisible(EarringsHomePageLocator.clickOnsearchBar, 5);
            helper.enterAction(EarringsHomePageLocator.clickOnsearchBar);
